...
# @patch("pygnverifier.cli.Verifier")  # Adjusted path to match cli.py imports
# @patch("pygnverifier.cli.VerificationRequest")  # Adjusted path to match cli.py imports
# def test_verify_command(mock_verification_request, mock_Verifier, runner):
#     # Mocking Verifier and VerificationRequest behavior
#     mock_Verifier_instance = MagicMock()
#     mock_Verifier.return_value = mock_Verifier_instance
#     mock_response = MagicMock()
#     mock_Verifier_instance.verify.return_value = mock_response
...
#     # Mocking DataSourceClient's iter_data_sources method
#     mock_client_instance = MagicMock()
#     mock_data_source_client.return_value = mock_client_instance
#     mock_client_instance.iter_data_sources.return_value = [
#         MagicMock(
#             datasource_id=1,
