...
# @patch("requests.get")
# def test_iter_data_sources(mock_get, mock_data):
...
#     data_sources = client.iter_data_sources()
...
# @patch("requests.get")
# def test_iter_data_sources_empty(mock_get):
